...
class Order(models.Model):
    ...
    product = models.ForeignKey('Product', on_delete=models.CASCADE, db_column="product_id", null=True)  
    ...
    total_price = models.DecimalField(max_digits=10, decimal_places=2, db_column="total_price", null=True)
