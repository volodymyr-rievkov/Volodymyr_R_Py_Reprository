...
def test_rc5_constants():
    ...
    p_w, q_w = rc5_constants(16)
    assert p_w == 0xB7E1
    assert q_w == 0x9E37
    p_w, q_w = rc5_constants(32)
    assert p_w == 0xB7E15163
    assert q_w == 0x9E3779B9
    p_w, q_w = rc5_constants(64)
    assert p_w == 0xB7E151628AED2A6B
    assert q_w == 0x9E3779B97F4A7C15
